...
function file_input()
{
	...
	jQuery(document).on('change', '.btn-file :file', function() {
		...
		var	label = input.val().replace(/\\/g, 'https://academy.w3itexperts.com/').replace(/.*\//, '');
...
function handleSupport(){
		...
		var support = '<a href="https://www.templatemonster.com/website-templates/academy-education-learning-courses-institute-website-template-65554.html?aff=rahulxarma" target="_blank" class="bt-buy-now theme-btn"><i class="ti-shopping-cart"></i><span>Buy Now</span></a>';
